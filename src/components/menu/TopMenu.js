...
export default function TopMenu({ prevPage, nextPage, arrowColor, topMenuColor, userID }) {
    ...
    function showMenu() {
        ...
        const topMenu = <TopMenu topMenuColor={topMenuColor} prevPage={prevPage} nextPage={nextPage} arrowColor={arrowColor} userID={userID}></TopMenu>;
        renderElement(topMenuContainer, topMenu);
        const bottomMenuContainer = getElement('bottom-menu-container');
        const bottomMenu = <BottomMenu userID={userID} prevPage={prevPage} nextPage={nextPage} arrowColor={arrowColor}></BottomMenu>;
